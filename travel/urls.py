...
from tour.views import update_booking_status
from tour.views import create_checkout_session


urlpatterns = [
    path('secure-admin/', admin.site.urls),  # Update the admin URL
    ...
    path('places_detail/<int:pr_id>/', views.places_detail, name='places_detail'),
